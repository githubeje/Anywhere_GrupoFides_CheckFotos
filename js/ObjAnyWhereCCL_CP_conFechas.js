...
function ObjAnyWhereCCL_CP(paramJSON) {
	...
	this.getHtml = function() {
		...
		if(this.json.omit4 != "yes"  ) {
			html+=	"<div class='ui-field-contain ui-body ui-br' data-role='fieldcontain'>" +
						"<label for='selectDesde_"+this.num+"' class='ui-select'>"+this.json.getLabel4+":</label>" +
				   		"<div class='ui-select'>" +
				   			"<input type='date' eje-type='number' class='required' " +
				   				"name='selectDesde_"+this.num+"' id='selectDesde_"+this.num+"' >" +
						"</div>" +
					"</div>";	
		}
		...
		if(this.json.omit5 != "yes"  && this.json.omit4 != "yes") {
			html+=	"<div class='ui-field-contain ui-body ui-br' data-role='fieldcontain'>" +
						"<label for='selectHasta_"+this.num+"' class='ui-select'>"+this.json.getLabel5+":</label>" +
				   		"<div class='ui-select'>" +
				   			"<input type='date' eje-type='number' class='required' " +
				   				"name='selectHasta_"+this.num+"' id='selectHasta_"+this.num+"' >" +
						"</div>" +
					"</div>";
		}
...
//		}
	...
	this.getDesde = function() {
		var valorDesde = $("#selectDesde_"+this.num).val();
		var stringDesde = valorDesde.toString().slice(0,10).replace(/-/g,"");
		return stringDesde;
	};
	
	this.getHasta = function() {
		var valorHasta = $("#selectHasta_"+this.num).val();
		var stringHasta = valorHasta.toString().slice(0,10).replace(/-/g,"");
		return stringHasta;
	};
